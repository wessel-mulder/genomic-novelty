...
al <- read.dna('../../Data/0_preprocessing/BUSCO_alignments_no_stop/1000at32523.fa', format="fasta")
...
write.dna(al_no_heterozygous, '../../Data/0_preprocessing/BUSCO_alignments_trimmed/1000at32523.fa', 
          format="fasta", colsep = "")
