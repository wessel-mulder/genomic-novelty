...
al <- read.dna('../../Data/0_preprocessing/BUSCO_alignments_trimmed_final_pis/1000at32523.fa', format = "fasta")
...
write.table(dist, '../../Data/0_preprocessing/dist_matrices/1000at32523.dist', row.names=TRUE, col.names=TRUE)
